...
export function AboutPage() {
  return (
    <section className="conatiner__about">
      ...
      <p className="about__titletext">
        PERSONAS: Hay personas que se esfuerzan en poner toda su alma, cariño y
        cuidado a todo lo que hacen.
      </p>
      <p className="about__titletext">
        ARTESANOS: Ellos son los crafters. Artesanos que crean sus productos con
        auténtica pasión.
      </p>
      <p className="about__titletext">
